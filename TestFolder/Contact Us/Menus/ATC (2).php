    ...
    <script>
        ...
        function proceedToCheckout() {
            ...
            <?php else: ?>
                ...
                if (confirm("You need to log in or sign up for an account to proceed to checkout. Do you want to go to the login/signup page?")) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href='Atc.php?action=clearall'>
                                        <button class='btn btn-success btn-block btn-custom'>Clear Cart</button>
                                    </a>
                                </td>
                            </tr>
                            ";
