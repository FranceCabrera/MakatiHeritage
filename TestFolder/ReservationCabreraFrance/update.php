...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['search_id'])) {
    ...
    $sql = "SELECT * FROM tbl_reservations WHERE userID = '$userID'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_id'])) {
    ...
    $sql = "UPDATE tbl_reservations SET fname = '$fname', lname = '$lname', emailAdd = '$email' WHERE userID = '$userID'";
    ...
    <?php else: ?>
        ...
        <?php if ($user): ?>
            <form action="update.php" method="post">
                ...
                <input type="email" id="email" name="email" value="<?php echo $user['emailAdd']; ?>" required>
