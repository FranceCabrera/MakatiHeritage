    ...
    <main>
        ...
        <form action="view.php" method="get">
            ...
            <select id="sort" name="sort">
                <option value="emailAdd" <?php if (isset($_GET['sort']) && $_GET['sort'] == 'emailAdd') echo 'selected'; ?>>Email</option>
        ...
        <table>
            ...
            $sql = "SELECT userID, CONCAT(lname, ', ', fname) AS name, emailAdd, dateReg FROM tbl_reservations";
            if ($search) {
                $sql .= " WHERE lname LIKE '$search%' OR fname LIKE '$search%' OR emailAdd LIKE '$search%'";
            }
