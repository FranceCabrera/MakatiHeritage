...
<body class="feed-back-body">
  ...
  if (!isset($_SESSION['userID'])) {
    echo "<div class='message-container'><p class='message' style='color: red;'>You need to be logged in to submit feedback.</p></div>";
    exit;
  }
    ...
    <div id="feedback-container">
      ...
      <form method="POST" action="">
        <label for="rbPgRating">
          <div class="feedbackLabel">How would you rate our site?</div>
        </label>
